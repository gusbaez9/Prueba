let productos = [
    ...
    { nombre: "Autos", categoria: "Juguetes", precio: 150 },
...
for (let i = 0; i < productos.length; i++) {
    ...
    if (productos[i].categoria == "Juguetes" && productos[i].nombre === "autos") {
        ...
        totalDescuentoJug += productos[i].precio * aumento1;
        productos[i].precio = productos[i].precio * aumento1;
    }
